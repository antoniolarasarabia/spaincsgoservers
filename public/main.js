...
/* harmony import */ var _servidores_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./servidores.service */ "./src/app/servidores.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    { path: '**', component: _my_nav_my_nav_component__WEBPACK_IMPORTED_MODULE_5__["MyNavComponent"] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_servidores_service__WEBPACK_IMPORTED_MODULE_10__["ServidoresService"]],
...
/* harmony import */ var _servidores_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../servidores.service */ "./src/app/servidores.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyNavComponent = /** @class */ (function () {
    function MyNavComponent(breakpointObserver, servidoresService) {
    ...
    MyNavComponent.prototype.ngOnInit = function () {
        ...
        this.servidoresService.getServidores()
            ...
            _this.servidores.sort(function (a, b) {
                if (a.players > b.players)
                    return -1;
                else if (a.players < b.players)
                    return 1;
                else
                    return 0;
            });
        });
        var source = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(90000);
        var subscribe = source.subscribe(function (val) {
            console.log('Aqui se entra');
            _this.servidoresService.getServidores()
                .subscribe(function (data) {
                _this.servidores = data;
                _this.servidores.sort(function (a, b) {
                    if (a.players > b.players)
    ...
    MyNavComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_1__["BreakpointObserver"], _servidores_service__WEBPACK_IMPORTED_MODULE_3__["ServidoresService"]])
    ], MyNavComponent);
...
/***/ "./src/app/servidores.service.ts":
/*!***************************************!*\
  !*** ./src/app/servidores.service.ts ***!
  \***************************************/
/*! exports provided: ServidoresService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServidoresService", function() { return ServidoresService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var url = '/servidores';
var ServidoresService = /** @class */ (function () {
    function ServidoresService(http) {
        this.http = http;
    }
    ServidoresService.prototype.getServidores = function () {
        var _this = this;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            _this.servidores = data.servidoresFinal;
            return _this.servidores;
        }));
    };
    ServidoresService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
    ], ServidoresService);
    return ServidoresService;
}());
...
module.exports = __webpack_require__(/*! C:\Users\ANTONIO\Desktop\SERVERPROJECCT\frontend\src\main.ts */"./src/main.ts");
